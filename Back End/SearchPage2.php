...
<h4 align=center>Search Course</h4>
...
<tr>
<td><input method ="POST" type="radio" class="radio" name ="Day" value ="Monday/Wednesday"> Monday/Wednesday</label>
<input method ="POST" type="radio"class="radio" name ="Day" value ="Tuesday/Thursday"> Tuesday/Thursday</label></td>
...
<td><input type="Submit" name="Submit" value ="Search" title="Submit"/></td>
</form>
<tr>
</table>
